...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = 'w(ﾟДﾟ)w 你个出生，滚蛋';
    clearTimeout(titleTime);
  }
  else {
    //返回当前页面时标签显示内容
    document.title = '♪(^∇^*)别搞，正常文章！' + OriginTitile;
    //两秒后变回正常标题
...
const live2d_path = "https://github.com/bloyet/tupian/tree/main/live2d-widget/";  //xxx.xx 改成你网站的域名https://github.com/bloyet/tupian/tree/0987f0a17cae46f9ade6315f687c5720bc5652b5/live2d-widget
